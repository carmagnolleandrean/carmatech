        ...
        try {
            ...
            if ($utilisateurExistant->rowCount() == 0) {
                ...
                if ($infosUtilisateur) {
                    ...
                    $erreurMsg = "Erreur lors de la récupération des informations utilisateur.";
                }
            } else {
                $erreurMsg = "L'utilisateur existe déjà avec cet e-mail.";
            }
        } catch (PDOException $e) {
            $erreurMsg = "Erreur lors de la connexion à la base de données : " . $e->getMessage();
        }
    } else {
        $erreurMsg = "Veuillez compléter tous les champs.";
    }
}
?>
